...
public class Controladora {
    ...
    private void cargarDatosDePrueba() {
        ...
        Tipo tConsola  = new Tipo("Consola",     "Donde jugar videojuegos");
        Tipo tControl  = new Tipo("Control",     "Mando o gamepad para consola");
        Tipo tPelicula = new Tipo("Pelicula DVD","Pelicula en un formato de DVD");
        ...
        Categoria cAccion      = new Categoria("Accion",        "Juegos y peliculas de accion intensa");
        ...
        Categoria cTerror      = new Categoria("Terror",        "Juegos y peliuculas de terror");
        Categoria cAnimacion   = new Categoria("Animacion",     "Peliculas y series animadas");
        Categoria cScienceFi   = new Categoria("Ciencia Ficcion","Tematica del futuro y espacial");
        ...
        Categoria cRetro       = new Categoria("Retro",         "Clasicos de generaciones pasadas");
        Categoria cBandaSonora = new Categoria("Banda Sonora",  "Soundtracks de videojuegos o peliculas");
        ...
        Item g9 = new Item("VJ009", "GoldenEye 007 (N64)",       "Clasico shooter de Nintendo 64",                tJuego);
        ...
        Item c1 = new Item("CS001", "PlayStation 5",             "Consola de nueva generacion de Sony",           tConsola);
        c1.agregarCategoria(cPlayStation);

        Item c2 = new Item("CS002", "Xbox Series X",             "Consola de nueva generacion de Microsoft",      tConsola);
        c2.agregarCategoria(cXbox);

        Item c3 = new Item("CS003", "Nintendo Switch OLED",      "Consola híbrida portatil/sobremesa",            tConsola);
        c3.agregarCategoria(cNintendo);

        Item c4 = new Item("CS004", "PlayStation 2",             "Consola clasica de Sony - la más vendida",      tConsola);
    ...
    public boolean eliminarUsuario(Usuario u) {
        if (u == null) return false;
        if (!u.getPrestamosActivos().isEmpty()) return false;
    ...
    public boolean hacerPrestamo(Usuario usuario, List<Item> itemsSeleccionados) {
        ...
        for (Item item : itemsSeleccionados) {
            if (!item.estaDisponible()) return false; 
            p.incluirItem(item);
        }
